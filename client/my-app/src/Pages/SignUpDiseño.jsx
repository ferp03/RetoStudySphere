                ...
                <div className='FormsContainer'>
                    ...
                    <div className='titleIconContainer'>
                        ...
                        <div className='LoginButtonContainer'>
                            <button type="button" className="btn btn-dark" style={{width: '90%', height: '60px', borderRadius: '15px'}}>Sign Up</button>
                        </div>
                        ...
                        <div className='LoginRegistrateContainer'>
                            ...
                            <label style={{cursor: 'pointer', color: 'blue', textDecoration: 'underline', marginLeft: 5}}> Inicia sesión</label>
                        </div>
                </div>
            </div> 
